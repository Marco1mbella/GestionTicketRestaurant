<?php 
   ...
   class Model {
        ...
        private static function init(){
            self::$className = get_called_class();//On recupere le nom de la classe

            $foo = new self::$className();//on crée une nouvelle instance de classe
            //on verifie si pour l'instance il y a une requete a executer
        ...
        //on charge la requete à executer
        ...
        //on recupere l'id de la table dans la base
