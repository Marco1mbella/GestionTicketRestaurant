           ...
           <div class="content-header row">
                  ...
                  <div class="col-md-4 col-xs-12 dropdown" id="dropdown-a" style="text-align: right;">          
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="dropdown-a">
                      ...
                      <a class="dropdown-item" id="EmailUser" onclick="w3.sortHTML('#myTableU', '.item', 'td:nth-child(1)')" style="cursor:pointer" title="cliquer ici pour les classer">
                          <i class="fa fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                        By Email
                      </a>
                      <a class="dropdown-item" id="nbrCmd">
                        <i class="fa fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                        By Commands
                      </a>
